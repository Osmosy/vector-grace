...
- **[Anthropization trap](references/anthropization-trap.md)** — антропизация пайплайна = главная ошибка. ТЗ для агентов — субоптимально, прототип с семантикой — нормально. Claude тянет кривой пайплайн на мощи, деградация незаметна. Тест на средних LLM вскрывает кривизну.
