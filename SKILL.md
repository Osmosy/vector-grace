...
- **[Penpot](references/penpot.md)** — open-source альтернатива Figma, self-hosted, MPL-2.0. Design tokens, CSS Grid/Flex, MCP server для AI-driven workflows, open API. Design expressed as code (SVG/CSS/HTML/JSON).
